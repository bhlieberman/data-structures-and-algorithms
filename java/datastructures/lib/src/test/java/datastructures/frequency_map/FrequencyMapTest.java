...
public class FrequencyMapTest {
  ...
  void testFreqMap() {
    ...
    String sut1 = "Once upon a time, there was a brave princess who";
    String sut2 = """
    It was the best of times, it was the worst of times, it was the age of wisdom,
    it was the age of foolishness, it was the epoch of belief, it was the epoch of incredulity, it was the season of
    ...
    String sut3 = "It was a queer, sultry summer, the summer they electrocuted the Rosenbergs, and I didn't know what I was doing in New York";
    assertEquals("a", fm.frequencyMapStream(sut1));
    assertEquals("the", fm.frequencyMapStream(sut2));
    assertEquals("was", fm.frequencyMapStream(sut3));
  }
}
